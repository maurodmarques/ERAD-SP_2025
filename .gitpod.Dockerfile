...
RUN wget https://github.com/hpcc-systems/HPCC-Platform/releases/download/community_9.10.30-1/hpccsystems-platform-community_9.10.30-1focal_amd64_withsymbols.deb

RUN sudo apt-get install -y --fix-missing ./hpccsystems-platform-community_9.10.30-1focal_amd64_withsymbols.deb
RUN rm -f hpccsystems-platform-community_9.10.30-1focal_amd64_withsymbols.deb
