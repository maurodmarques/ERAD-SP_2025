...
RUN wget https://github.com/hpcc-systems/HPCC-Platform/releases/download/community_9.6.72-1/hpccsystems-platform-community_9.6.72-1focal_amd64_withsymbols.deb

RUN sudo apt-get install -y --fix-missing ./hpccsystems-platform-community_9.6.72-1focal_amd64_withsymbols.deb
RUN rm -f hpccsystems-platform-community_9.6.72-1focal_amd64_withsymbols.deb
